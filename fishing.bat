...
echo.                Costs 1000 Gold.
echo 2) Small Boat:    %boat2%
echo.                Costs 5000 Gold.
echo 3) Large Boat:   %boat3%
echo.                Costs 50000 Gold.
echo 4) Rich Boat:    %boat4%
echo.                Costs 125000 Gold.
echo 5) Pro Boat:     %boat5%
echo.                Costs 250000 Gold.
echo 6) Dream Boat:   %boat6%
echo.                Costs 500000 Gold.
echo 7) Elegant Boat: %boat7%
echo.                Costs 1000000 Gold.
echo 8) Titanic:      %boat8%
echo.                Costs 10000000 Gold.
echo 9) Goto Menu
set /p v1=
if %v1% == 1 goto boat1
if %v1% == 2 goto boat2
